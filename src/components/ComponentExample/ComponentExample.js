 ...
 */
const ComponentExample = ({ htmlFile, component, variant, codepenSlug, copyButtonTimeout, hideViewFullRender }) => {
  ...
  return (
    <div className={lightUIclassnames}>
      ...
      <CodeExample htmlFile={htmlFile} copyButtonTimeout={copyButtonTimeout} />
    </div>
  );
};
